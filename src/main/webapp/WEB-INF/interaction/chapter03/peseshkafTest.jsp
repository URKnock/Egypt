...
<link href="<c:url value='/resources/css/interaction/ch03/peseshkafTest.css'/>" rel="stylesheet" type="text/css"/>
<div>
...
<script src="<c:url value='/resources/js/interaction/ch03/peseshkafTest.js'/>"></script>