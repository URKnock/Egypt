...
<link href="<c:url value='/resources/css/interaction/ch03/poursoda.css'/>" rel="stylesheet" type="text/css"/>
...
<script src="<c:url value='/resources/js/interaction/ch03/poursoda.js'/>"></script>