...
<body onload="init(); interaction();">
	<div id="background">
		<img id="ground" style="z-index: 2;" src="<c:url value='/resources/background/ch07/7_2_3.png'/>"/>
		...
		<img id="heart" style="z-index: 3;" class="select pikachu" src="<c:url value='/resources/object/ch03/organ_1.png'/>"/>
	...
	<form id="form" method="post" action="<c:url value='/chapter11'/>">
		...
		<div id="blur"></div>
		<audio id="bgm" preload="auto" src="/resources/bgm/ch10/10_bgm.mp3" loop="true" autobuffer></audio>
