...
function interaction() {	
	...
	setTimeout(function() {
	$(".snake1").attr("src",
			"/D/resources/object/ch05/뱀싸움.webp");
	}, 3500); 
	setTimeout(function() {
	$(".snake1_1").attr("src",
			"/D/resources/object/ch05/뱀잔상.webp");
	}, 3500); 	
	setTimeout(function() {
	$(".snake2").attr("src",
			"/D/resources/object/ch05/뱀싸움.webp");
	...
	$(".snake1").on("click", function() {
			...
			"/D/resources/character/ch05/창든사자(위)_2대기.webp").clearQueue().stop(); }, 2000);
			if(snake1 == 2) {
			cnt++;
			$(".snake1").attr("src", 
			"/D/resources/object/ch05/뱀_죽음왼.webp").fadeOut(2000);
			$(".snake1_1").fadeOut(1000);
			$(".s2").attr("src", 
			"/D/resources/object/ch05/뱀만다라1.webp");	
			$(".s4").attr("src", 
			"/D/resources/object/ch05/뱀만다라2.webp");			
			}
	...
	$(".snake2").on("click", function() {
			...
			//다시 원상태
			setTimeout(function() {$(".saja").attr("src", 
			"/D/resources/character/ch05/창든사자(위)_2대기우.webp").clearQueue().stop(); }, 2000);
			if(snake2 == 2) {
			cnt++;
			$(".snake2").attr("src", 
			"/D/resources/object/ch05/뱀_죽음왼.webp").fadeOut(2000);
			...
			$(".s3").attr("src", 
			"/D/resources/object/ch05/뱀만다라3.webp");	
			$(".s1").attr("src", 
			"/D/resources/object/ch05/뱀만다라4.webp");			
			}
