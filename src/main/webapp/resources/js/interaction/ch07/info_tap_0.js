...
obj[3] = document.querySelector('#interact .character:nth-of-type(5)');
obj[2] = document.querySelector('#interact .character:nth-of-type(6)');
...
motion[3] = "resources/webp/ch07/horus_motion.webp";
motion[2] = "resources/webp/ch07/thoth_motion.webp";
...
webp[3] = "resources/webp/ch07/horus.webp";
webp[2] = "resources/webp/ch07/thoth.webp";
...
png[3] = "resources/webp/ch07/horus.png";
png[2] = "resources/webp/ch07/thoth.png";
...
function tap_info(e, i) {
	...
	var time;
	if(i == 0) time = 2300;
	else if(i == 1) time = 2000;
	else if(i == 3) time = 1050;
	else if(i == 2) time = 2000;
