...
function init() { //화면 초기화
	...
	stone1.css("bottom", ($("#background").height() / 2.0) - 200*w);
	...
	stone2.css("bottom", ($("#background").height() / 2.0) - 200*w);
	...
	stone3.css("bottom", ($("#background").height() / 2.0) - 200*w);
	...
	banner.css("left", view1.css("left"));
