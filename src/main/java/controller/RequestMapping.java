...
public class RequestMapping {  
    ...
    public void initMapping() {
		...
		mappings.put("/chapter11part2", new ForwardController("/interaction/chapter11/chapter11_2.jsp"));
		mappings.put("/chapter11part3", new ForwardController("/interaction/chapter11/chapter11_3.jsp"));
    }
